...
const VCard: FC<vCardProps> = (_props: vCardProps) => {
  ...
  //   e.preventDefault();
  //   const img = await vCardService?.get({
  //     from: 'NJQXSYLOORUAU@xmpp.staging.desklessworkers.com',
  //     to: 'NZQXM6LBBI@xmpp.staging.desklessworkers.com'
  //   });
  //   // if (img.profileImage !== undefined) {
  //   //   setValue(img.profileImage);
  //   // }
  //   console.log('value', img.profileImage);
